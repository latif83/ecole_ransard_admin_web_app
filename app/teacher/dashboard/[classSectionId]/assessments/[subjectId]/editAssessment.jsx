...
export const EditAssessment = ({ setEditAssessment, assessmentData, setGetData }) => {
    ...
    useEffect(() => {
        ...
        setFormData((prevData) => ({
            ...prevData, name: assessmentData.name, description: assessmentData.description, weight: assessmentData.weight, marks: assessmentData.marks, academicTermId: assessmentData.academicTermId,
            classSessionId: assessmentData.classSessionId,
    ...
    useEffect(() => {
        ...
        const sendAssessmentData = async () => {
            ...
            try {
                ...
                const response = await fetch(`${serverUrl}/teacher/update_assessment/${assessmentData.id}
`, {
                    method: 'PUT',
                    headers: {
        ...
        <div className={`${styles.container} sm:pt-10`}>
            <div className="w-full max-w-xl mx-auto bg-white dark:bg-black rounded shadow p-6">
                <div className="flex justify-between mb-3">
                    <h1 className="font-semibold">Edit Assessment</h1>
                    <FontAwesomeIcon
                        icon={faTimes}
                        onClick={() => setEditAssessment(false)}
