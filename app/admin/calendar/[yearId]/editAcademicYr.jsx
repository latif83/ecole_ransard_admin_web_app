...
export default function EditAcademicYr({ setEditAcademicYr, data, setFetchData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`/api/calendar/year/${data.id}`, {
                method: "PUT",
                headers: {
            ...
            setEditAcademicYr(false); // Close the modal or form after successful submission
        ...
        <div className="fixed inset-0 z-50 bg-gray-900 bg-opacity-50">
            <div className="bg-white w-full max-w-xl mx-auto p-6 mt-5 h-auto shrink-0 grow-0 rounded-md shadow-lg">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="font-bold">Edit Academic Year</h2>
                    <FontAwesomeIcon
                        onClick={() => setEditAcademicYr(false)}
                        icon={faTimes}
                        width={15}
                        height={15}
