...
export default function NewTerm({ setAddAcademicTerm, academicYearId, setFetchData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAddAcademicTerm(false); // Close the modal or form after successful submission
        ...
        <div className="fixed inset-0 z-50 bg-gray-900 bg-opacity-50">
            <div className="bg-white w-full max-w-xl mx-auto p-6 mt-5 h-auto shrink-0 grow-0 rounded-md shadow-lg">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="font-bold">Add New Academic Term</h2>
                    <FontAwesomeIcon
                        onClick={() => setAddAcademicTerm(false)}
                        icon={faTimes}
                        width={15}
                        height={15}
                ...
                <form onSubmit={handleSubmit}>
                    <div className="relative z-0 w-full group mb-5">
                        <input
                            ...
                            onChange={(e) => setFormData((prev) => ({ ...prev, termName: e.target.value }))}
                        ...
                        >
                            Academic Term (e.g Term 1, Spring)
                        </label>
                    </div>
                    <div className="relative z-0 w-full group mb-5">
                        <input
