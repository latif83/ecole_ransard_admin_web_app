...
export const EditClassSection = ({ classSectionData, setEditClassSection, setFetchData }) => {

    const [loading, setLoading] = useState(false)

    const [formData, setFormData] = useState({
        sectionId : classSectionData.sectionId,
        sectionName: classSectionData.sectionName,
        teacherId: classSectionData.teacher.id
    })
        ...
        <div className="fixed inset-0 z-50 bg-gray-900 bg-opacity-50">
            <div className="bg-white w-full max-w-xl mx-auto p-6 mt-5 h-auto shrink-0 grow-0 rounded-md shadow-lg">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="font-bold">Edit Section</h2>
                    <FontAwesomeIcon
                        onClick={() => setEditClassSection(false)}
                        icon={faTimes}
                        width={15}
                        height={15}
