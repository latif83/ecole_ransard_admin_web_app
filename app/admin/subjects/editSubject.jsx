...
export default function EditSubject({ setEditSubject, subjectData, setGData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("/api/subjects", {
                ...
                body: JSON.stringify({ name:subjectName, id}),
            });
            ...
            setEditSubject(false); // Close the modal or form after successful submission
