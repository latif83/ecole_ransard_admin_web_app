...
export default function EditStudent({ setEditStudent, setGData, studentData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`/api/students`, {
                ...
                body: JSON.stringify({ firstName, lastName, birthDate, address, classId, id, classSectionsId, passportImage: imageUrl }),
            });
            const responseData = await response.json();
            if (!response.ok) {
                toast.error(responseData.message);
    ...
    const [passportImage, setPassportImage] = useState(studentData.passportImage)
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex gap-6">
                        ...
                        <div className="w-[200px] shrink-0">
                            {passportImage ? <div className="rounded-lg h-[200px] w-[200px] border-2 border-blue-500 text-blue-500 flex items-center justify-center flex-col cursor-pointer p-0.5 relative">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex justify-end">
                                <button
                                    ...
                                    disabled={loading}
                                >
                                    {loading ? <> <FontAwesomeIcon icon={faSpinner} spin /> Save Changes </> : "Save Changes"}
                                </button>
                            </div>
                        </div>
                    </div>
